    ...
    <section class="container">
        <div class="row">
            <div class="col-sm-4 col-xl-2">
                <h5 class="text-success">{{isset($info['name']) ? $info['name'] : ''}}</h5>
            ...
            <div class="col-sm-4 col-xl-2">
                <h5 class="text-success">@lang('lang.terms_of_use')</h5>
                <ul class="list-unstyled text-small">
            ...
            <div class="col-sm-4 col-xl-2">
                <h5 class="text-success">@lang('lang.support')</h5>
                <ul class="list-unstyled text-small">
            ...
            <div class="col-sm-12 col-xl-6">
                <h5 class="text-success">@lang('lang.contact')</h5>
                <div class="row">
                ...
                <div class="row">
                    <p class="link-info text-success">
