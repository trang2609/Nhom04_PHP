    ...
    @foreach($theater->rooms as $room)
        <tr>
            ...
            <td class="align-middle">
                <a class="text-success font-weight-bold text-xs" href="admin/seat/{{ $room->id }}">
                    <i class="fa-solid fa-pen-to-square fa-lg"></i>
                </a>

            </td>
            <td class="align-middle">
                <a href="admin/room/delete/{{$room->id}}" class="text-danger font-weight-bold text-xs delete-room"
